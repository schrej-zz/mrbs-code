...
$db_host = "db593601272.db.1and1.com;
// If you need to use a non standard port for the database connection you
// can uncomment the following line and specify the port number
// $db_port = 1234;
// Database name:
$db_database = "db593601272";
// Schema name.  This only applies to PostgreSQL and is only necessary if you have more
// than one schema in your database and also you are using the same MRBS table names in
// multiple schemas.
//$db_schema = "public";
// Database login user name:
$db_login = "dbo593601272";
...
$mrbs_admin = "Hallenbuchung TSV Zirndorf";
$mrbs_admin_email = "halle@tsv-zirndorf.de";
...
$mrbs_company = "TSV 1861 Zirndorf e.V.";   // This line must always be uncommented ($mrbs_company is used in various places)
...
$max_secs_per_interval_global['day'] = 60*60*10;      // max 10 hours per day in total

$max_secs_per_interval_global_enabled['week']   = false;
$max_secs_per_interval_global['week'] = 60*60*50;    // max 50 hours per week in total

$max_secs_per_interval_global_enabled['month']  = false;
$max_secs_per_interval_global['month'] = 60*60*100;   // max 100 hours per month in total

$max_secs_per_interval_global_enabled['year']   = false;
$max_secs_per_interval_global['year'] = 60*60*500;   // max 500 hours per year in total

$max_secs_per_interval_global_enabled['future'] = false;
$max_secs_per_interval_global['future'] = 60*60*1000; // max 1000 hours in the future in total
...
$auth["session_cookie"]["secret"] = "Cookie des TSV 1861 Zirndorf a.V.";
...
$csrf_cookie["secret"] = "Cookie des TSV 1861 Zirndorf a.V.";
...
$auth["user"]["administrator"] = "tsv1861";
$auth["user"]["tsvadmin"] = "tsv1861";
$auth["user"]["joerg.schreiner"] = "nixda";
$auth["user"]["guenter.neff"] = "tsv1861";
...
$mail_settings['from'] = 'halle@tsv-zirndorf.de';
...
$mail_settings['recipients'] = 'halle@tsv-zirndorf.de';
...
$mail_settings['domain'] = 'tsv-zirndorf.de';
...
$smtp_settings['hostname'] = 'tsv-zirndorf.de';
...
$vocab_override["de"]["type.A"] = "Hauptverein";
$vocab_override["de"]["type.B"] = "Badminton";
$vocab_override["de"]["type.C"] = "Fussball";
$vocab_override["de"]["type.D"] = "Handball";
$vocab_override["de"]["type.E"] = "Leichtathletik";
$vocab_override["de"]["type.F"] = "Ringen";
$vocab_override["de"]["type.G"] = "Schwimmen";
$vocab_override["de"]["type.H"] = "Skiclub";
$vocab_override["de"]["type.I"] = "Tennis";
$vocab_override["de"]["type.J"] = "Volleyball";
$vocab_override["de"]["type.K"] = "Schach";
$vocab_override["de"]["type.L"] = "Schulen";
$vocab_override["de"]["type.M"] = "Aikido";

$vocab_override["de"]["type"] = "Abteilung";
